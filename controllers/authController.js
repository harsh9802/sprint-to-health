...
export const signup = catchAsync(async (req, res, next) => {
  const newUser = await User.create({
    // We only take the data that we need from boyd instead of the entire body
    // This way we avoid taking in the role field from the req.body
    name: req.body.name,
...
// Limit access to logged in user
...
export const forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    //Sending password reset emails - New method
